...
let questions = [
  ...
  {
    numb: 21,
    question: "Which of the following is considered a violation of anti-doping rules?",
    answer: "Tampering with a sample",
    options: [
      "Training at high altitude",
      "Tampering with a sample",
      "Using a legal painkiller",
      "Drinking sports drinks",
    ],
  },
  {
    numb: 22,
    question: "What is the main goal of out-of-competition testing?",
    answer: "To detect doping before competitions",
    options: [
      "To detect doping before competitions",
      "To monitor athlete performance",
      "To check for injuries",
      "To ensure athletes are participating in competitions",
    ],
  },
  {
    numb: 23,
    question: "What is the definition of 'blood doping'?",
    answer: "The illegal practice of increasing red blood cells to enhance performance",
    options: [
      "The use of anabolic steroids to increase muscle mass",
      "The illegal practice of increasing red blood cells to enhance performance",
      "The use of excessive hydration before a competition",
      "The use of oxygen masks for recovery",
    ],
  },
  {
    numb: 24,
    question: "What is one of the most common methods for detecting performance-enhancing drugs?",
  ...
  {
    numb: 25,
    question: "What does the term 'doping control' refer to?",
    answer: "The process of collecting samples and testing for prohibited substances",
    options: [
      "The process of collecting samples and testing for prohibited substances",
      "The training program athletes undergo before events",
      "The supervision of athletes' diets",
      "The coaching strategies used in sports",
    ],
  },
  {
    numb: 26,
    question: "What happens if an athlete tests positive for a banned substance?",
    answer: "They can be banned from competition for a period of time",
    options: [
      "They can be banned from competition for a period of time",
      "They receive a fine but are allowed to continue",
      "They are immediately disqualified from all future events",
      "They are put on probation with no further penalties",
    ],
  },
  {
    numb: 27,
    question: "Which of these substances is often included in the banned list?",
  ...
  {
    numb: 28,
    question: "What is one reason why athletes may be tempted to use performance-enhancing drugs?",
    answer: "Pressure to win and achieve better results",
    options: [
      "To improve overall health",
      "Pressure to win and achieve better results",
      "To enhance personal fitness",
      "To follow doctor's orders",
    ],
  },
  {
    numb: 29,
    question: "Which of these substances can trigger a doping violation if used without authorization?",
  ...
  {
    numb: 30,
    question: "What should athletes do if they suspect that a substance or method they are using is on the prohibited list?",
    answer: "Consult the World Anti-Doping Agency or their national anti-doping organization",
    options: [
      "Consult the World Anti-Doping Agency or their national anti-doping organization",
      "Ignore it as long as it’s not banned in their sport",
      "Wait until the next doping test to find out",
      "Stop using it only before a competition",
    ],
  },
...
function startQuiz() {
  ...
  // Function to display the current question with its serial number
  function showQuestion(index) {
    const question = selectedQuestions[index];

    // Display the question number
    document.getElementById("quiz-question-number").innerText = `Question ${index + 1}`; // Display serial number
