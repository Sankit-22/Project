...
//if user clicked on option
//if user clicked on option
// Modify the optionSelected function to include links to free courses
function optionSelected(answer) {
  ...
  if (userAns == correcAns) {
    ...
    // Add a link to a free course
    const courseLink = document.createElement("a");
    courseLink.href = `https://example.com/free-course?topic=${encodeURIComponent(
      questions[que_count].topic
    )}`; // Use a dynamic URL based on the question topic
    courseLink.textContent = `@Learn more about ${questions[que_count].topic} with this free course!`;
